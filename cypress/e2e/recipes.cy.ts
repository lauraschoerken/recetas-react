describe('Recipes', () => {
  ...
  describe('Create Recipe', () => {
    ...
    it('should create a new recipe', () => {
      ...
      cy.get('.ingredients-table-row input[placeholder="Nombre del ingrediente"]').first().type('Tomate');
  ...
  describe('Edit Recipe', () => {
    it('should edit an existing recipe', () => {
      ...
      cy.contains(`EditTest${timestamp}`).parents('.recipe-card').first().within(() => {
  ...
  describe('Delete Recipe', () => {
    it('should delete a recipe', () => {
      ...
      cy.get('.ingredients-table-row input[placeholder="Nombre del ingrediente"]').first().type('Test');
      cy.get('.ingredients-table-row input[type="number"]').first().clear().type('100');
      cy.get('button[type="submit"]').click();
      ...
      cy.contains(`DeleteTest${timestamp}`).parents('.recipe-card').first().within(() => {
