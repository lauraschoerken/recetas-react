          ...
          {!hasRequiredData ? (
            ...
            <div className="macros-display">
              ...
              <div className="macro-row macro-main">
                ...
                <span className="macro-value macro-calories">{recommendedMacros.calories} kcal</span>
              </div>
              <div className="macro-row">
            ...
            <div className="custom-macros-form">
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => handleChange('customCalories', parseInt(e.target.value) || undefined)}
                  placeholder="2000"
                />
              </div>
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange('customProtein', parseInt(e.target.value) || undefined)}
                    placeholder="150"
                  />
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange('customCarbs', parseInt(e.target.value) || undefined)}
                    placeholder="250"
                  />
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange('customFat', parseInt(e.target.value) || undefined)}
                    placeholder="65"
                  />
                </div>
              </div>
