...
export function DayCardRow({ title, type, days, onRemove, onMovePlan, onCook, onConsume }: DayCardRowProps) {
          ...
          <div className="cook-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="cook-modal-field">
              ...
              <input
                ...
                onChange={(e) => setLeftoverServings(Math.min(cookingPlan.servings, Math.max(0, parseInt(e.target.value) || 0)))}
              />
