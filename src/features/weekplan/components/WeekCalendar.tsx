...
export function WeekCalendar({ weekPlans, startDate, onRemove, onMovePlan, onCook, onConsume }: WeekCalendarProps) {
  const days = [];
    ...
    <div className="week-calendar-split">
      ...
      <div className="week-calendar-header">
        ...
        {days.map((day, index) => {
          ...
          const displayDate = day.date.toLocaleDateString('es-ES', { day: 'numeric', month: 'short' });
          return (
