...
import { WeekPlan, shoppingService } from '@/services/shopping';
import { 
  profileService, 
  RecommendedMacros, 
  DailyNutrition,
...
export function WeekPlanContainer() {
  ...
  useEffect(() => {
    ...
    console.log('Looking for day:', selectedDay, 'Available days:', weeklyNutrition.days.map(d => d.date));
  ...
  const handleCook = async (planId: number, leftoverServings: number, leftoverLocation: string) => {
    try {
      ...
      setWeekPlans(weekPlans.map(p => 
        p.id === planId ? { ...p, cooked: true } : p
      ));
      loadWeeklyNutrition();
  ...
  const macroDistribution = selectedDayNutrition 
    ? getMacroDistribution(selectedDayNutrition.protein, selectedDayNutrition.carbs, selectedDayNutrition.fat)
    : { protein: 0, carbs: 0, fat: 0 };
  
  const weeklyMacroDistribution = weeklyNutrition
    ? getMacroDistribution(weeklyNutrition.averages.protein, weeklyNutrition.averages.carbs, weeklyNutrition.averages.fat)
    : { protein: 0, carbs: 0, fat: 0 };
          ...
          <div className="daily-nutrition">
            {recommendedMacros && selectedDayNutrition ? (
                ...
                <div className="macro-progress-grid">
                  <div className="macro-progress-item">
                    <div className="macro-progress-header">
                      ...
                      <span className="macro-progress-values">
                        <strong>{selectedDayNutrition.calories}</strong> / {recommendedMacros.calories} kcal
                      </span>
                    </div>
                    <div className="progress-bar">
                      <div 
                        ...
                        style={{ width: `${getProgressPercent(selectedDayNutrition.calories, recommendedMacros.calories)}%` }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="macro-progress-item">
                    <div className="macro-progress-header">
                      ...
                      <span className="macro-progress-values">
                        <strong>{selectedDayNutrition.protein}g</strong> / {recommendedMacros.protein}g
                      </span>
                    </div>
                    <div className="progress-bar">
                      <div 
                        ...
                        style={{ width: `${getProgressPercent(selectedDayNutrition.protein, recommendedMacros.protein)}%` }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="macro-progress-item">
                    ...
                    <div className="progress-bar">
                      <div 
                        ...
                        style={{ width: `${getProgressPercent(selectedDayNutrition.carbs, recommendedMacros.carbs)}%` }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="macro-progress-item">
                    ...
                    <div className="progress-bar">
                      <div 
                        ...
                        style={{ width: `${getProgressPercent(selectedDayNutrition.fat, recommendedMacros.fat)}%` }}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="macro-chart-container">
                    ...
                    >
                      <div className="macro-donut-hole">
                        <span className="macro-donut-calories">{selectedDayNutrition.calories}</span>
              ...
              <div className="nutrition-empty">
                ...
                <Link to="/settings" className="btn btn-outline btn-sm">Ir a Ajustes</Link>
              </div>
              ...
              <>
                <div className="weekly-summary-stats">
                  <div className="weekly-summary-section">
                    ...
                    <div className="weekly-stats">
                      <div className="weekly-stat">
                        <span className="stat-value calories">{weeklyNutrition.averages.calories}</span>
                      ...
                      <div className="weekly-stat">
                        <span className="stat-value protein">{weeklyNutrition.averages.protein}g</span>
                  ...
                  <div className="weekly-summary-section">
                    ...
                    <div className="weekly-stats">
                      <div className="weekly-stat">
                        <span className="stat-value">{weeklyNutrition.totals.calories.toLocaleString()}</span>
                        <span className="stat-label">kcal</span>
                      </div>
                      <div className="weekly-stat">
                ...
                {weeklyNutrition.averages.calories > 0 && (
                  <div className="macro-chart-container">
                    ...
                    >
                      <div className="macro-donut-hole">
                        <span className="macro-donut-calories">{weeklyNutrition.averages.calories}</span>
